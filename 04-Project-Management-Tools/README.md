# 04: Project Management & QA Tools

In Quality Assurance, testing is only one part of the job. The other critical part is tracking, managing, and communicating the work. This is where Project Management tools become essential.

For a QA Engineer, these tools are our "central hub" for:
* **Bug Tracking:** Creating, updating, and prioritizing defect reports.
* **Test Case Management:** Often, linking test cases to requirements.
* **Collaboration:** Communicating with developers, PMs, and stakeholders.
* **Visibility:** Understanding the status of the project and what needs to be tested.
...
* **Core Use:** Its main strength is integrating project management *directly* with source code repositories (like Git, SVN, Perforce). It's a popular choice for teams that want everything in one place, especially in game development and high-security industries.
